...
export { getArchitectSkillTemplate, getOpsxArchitectCommandTemplate } from './workflows/architect.js';
export { getReviseSkillTemplate, getOpsxReviseCommandTemplate } from './workflows/revise.js';
