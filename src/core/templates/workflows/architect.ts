 ...
 *
 * Architect workflow: goal-driven architectural design mode.
 */
import type { SkillTemplate, CommandTemplate } from '../types.js';
import { STORE_SELECTION_GUIDANCE } from './store-selection.js';

export function getArchitectSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: `Design the architecture for a specific goal. Produce \`architecture.md\` as a first-class change artifact.
...
export function getOpsxArchitectCommandTemplate(): CommandTemplate {
  return {
    name: 'OPSX: Architect',
    description: 'Goal-driven architectural design mode - design the best architecture for your goal',
    category: 'Workflow',
    tags: ['workflow', 'architect', 'architecture', 'design'],
    content: `Design the architecture for a specific goal. Produce \`architecture.md\` as a first-class change artifact.
